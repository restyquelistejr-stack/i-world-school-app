...
// ✅ FIX: Use a dummy URL/key so the build NEVER crashes, even if env vars are missing during 'npm run build'
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://rrealtsrnktaragpuyae.supabase.co';
